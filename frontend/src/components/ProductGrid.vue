...
<nav aria-label="Page navigation example" style="margin: 35px; margin-top:20px">
  <ul class="pagination pagination-circle">

    <li class="page-item active">
      <a class="page-link" href="#" aria-label="Previous" v-on:click="setPageNum(page-1); setPageItems()">
        <span aria-hidden="true">&laquo;</span>
      </a>
    </li>
   

    <li class="page-item" v-for='index in Math.ceil(products.length/itemsPerPage)' :key='index'>
    <a class="page-link" href="#" v-on:click="setPageNum(index-1); setPageItems()">{{index}}</a>
    </li>
  
    <li class="page-item active">
      <a class="page-link" href="#" aria-label="Next" v-on:click="setPageNum(page+1); setPageItems() ">
